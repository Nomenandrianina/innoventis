...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20231004_innoventisgroupe_f6d715971139fc119967_20231004101208_archive.zip';
        const ARCHIVE_SIZE       = '172167688';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'f6d7159-04101208';
        const SECONDARY_PACKAGE_HASH = '7c38f7c-04101208';
        const VERSION            = '1.5.6';
