<section class="hero">
    ...
    <div class="content">
        ...
        <div class="stat">
            ...
            <div class="rect">
                <strong class="number purecounter" data-purecounter-start="0" data-purecounter-end="<?php the_field('stat_annee'); ?>"><?php the_field('stat_annee'); ?></strong>
                <strong class="text"><?php the_field('stat_annee_titre'); ?></strong>
            </div>
            <div class="rect">
                <strong class="number purecounter" data-purecounter-start="0" data-purecounter-end="<?php the_field('stat_collaborateur'); ?>"><?php the_field('stat_collaborateur'); ?></strong>
                <strong class="text"><?php the_field('stat_collaborateur_titre'); ?></strong>
            </div>
            <div class="rect">
                <strong class="number purecounter"  data-purecounter-start="0" data-purecounter-end="<?php the_field('stat_client'); ?>"><?php the_field('stat_client'); ?></strong>
